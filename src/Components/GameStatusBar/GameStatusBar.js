...
return (
  <div id="gameStatusBar">
    <div id="gameStatusBarContainer">
      ...
      {helpOpen && <p id="helpText"><span>Help</span> <br/> <hr/> Find all the things in the picture by clicking on the thing and selecting it in the menu. Try to be fast since it is timed.</p>}
